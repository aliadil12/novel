      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-2xl font-bold text-primary mb-4">عالم الروايات</h3>
            <p className="mb-4 text-muted-foreground">اكتشف عالماً من الروايات المترجمة في متناول يديك.</p>
          </div>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h4 className="text-lg font-semibold mb-4 text-foreground">روابط سريعة</h4>
            <ul className="space-y-2">
              <li><Link href="#" className="text-muted-foreground hover:text-primary transition-colors">من نحن</Link></li>
        ...
        <div className="mt-8 text-center text-muted-foreground">
          <p>&copy; 2023 عالم الروايات. جميع الحقوق محفوظة.</p>
        </div>
      </div>
    </footer>
  )
